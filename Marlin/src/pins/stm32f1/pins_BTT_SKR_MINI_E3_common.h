...
// Servos
//
#define SERVO0_PIN                          PC14   // SERVOS // MS 01.12.2021 - inverted servo and probe pins
...
//
#define Z_MIN_PROBE_PIN                     PA1  // PROBE // MS 01.12.2021 - inverted servo and probe pins

//#define Z_MIN_PIN                           Z_MIN_PROBE_PIN // not there for SKR mini E3 v2
